...
const METRIC_QUOTE_PATTERNS: Record<MetricFact['metricCode'], RegExp[]> = {
  ...
  operatingCashFlow: [
    /(?:net )?cash (?:provided by|from|generated by) operating activities/i,
  ...
  totalLiabilities: [/total liabilities/i, /负债合计/],
  totalEquity: [/(?:total )?(?:stockholders'|shareholders'|owners') equity/i, /所有者权益.{0,10}合计/, /股东权益.{0,10}合计/],
