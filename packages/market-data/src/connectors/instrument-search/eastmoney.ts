...
const MARKET_BY_MKTNUM: Record<
  string,
  { market: InstrumentSearchMarket; exchange: string; currency: string; yahooSuffix: string }
> = {
...
export class EastMoneyInstrumentSearchProvider implements InstrumentSearchPort {
  ...
  private toResult(item: EastMoneyItem): InstrumentSearchResult {
