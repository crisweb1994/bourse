 ...
 *
 * Endpoint pattern:
 *   https://datacenter.eastmoney.com/securities/api/data/v1/get?reportName=X
  ...
  return {
    async fetchFinancials(
      ...
      try {
        ...
        const [incomeRes, balanceRes, cashflowRes] = await withTimeout(ctx, ctx.timeoutMs ?? timeoutMs, (signal) =>
          Promise.all([
