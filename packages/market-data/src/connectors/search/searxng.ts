...
export interface SearxngSearchQuery {
  query: string;
  count: number;
...
export interface SearxngAdapterContext {
  signal?: AbortSignal;
  timeoutMs: number;
}
...
export interface SearxngWebSearchAdapter {
  readonly name: 'searxng';
  search(
    query: SearxngSearchQuery,
    ctx: SearxngAdapterContext,
